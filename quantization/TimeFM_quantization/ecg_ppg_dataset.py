...
class ECGPPGDataset(Dataset):
    def __init__(self, csv_folder, finetune, minmax, cache_size, dataset, transform=None):
        """
        ...
        for file in os.listdir(csv_folder):
            # print(file)
            if file.endswith('.csv') and file.startswith(dataset):  # Adjust extension if needed
